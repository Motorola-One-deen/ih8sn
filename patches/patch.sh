...
apply_patch frameworks/base 0001-spoof-build-fingerprint-for-google-play-services.patch
apply_patch frameworks/base 0002-use-fingerprint-walleye-pixel-2.patch
